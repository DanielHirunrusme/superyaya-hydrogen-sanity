...
export const Container = styled('article', {
  variants: {
    type: {
      ...
      pageDescription:'px-mobile md:px-0 md:max-w-[23.321vw] 2xl:max-w-[30.15625vw]', //About & Collection paragraph at top
      assistance:
        'md:max-w-[51.289vw] xl:max-w-[44.773vw] 2xl:max-w-[41.953125vw]',
