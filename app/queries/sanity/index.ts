...
export const INDEX_QUERY = groq`
  *[(_type == "product" && !store.isDeleted && store.status != "draft") || _type == "season" || _type == "collaboration" || _type == "archive" || _type == "project" && !(_id in path("drafts.**"))] | order(_type asc, _createdAt desc){
    _type,
    _id,
    // Product
